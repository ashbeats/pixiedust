...
class PixiedustInstall(InstallKernelSpec):
    def __init__(self, **kwargs):
        ...
        self.spark_download_urls = {
            ...
            '2.0.2': 'https://archive.apache.org/dist/spark/spark-2.0.2/spark-2.0.2-bin-hadoop2.7.tgz',
            '2.1.0': 'https://archive.apache.org/dist/spark/spark-2.1.0/spark-2.1.0-bin-hadoop2.7.tgz',
            '2.2.0': 'https://archive.apache.org/dist/spark/spark-2.2.0/spark-2.2.0-bin-hadoop2.7.tgz',
            '2.3.2': 'https://archive.apache.org/dist/spark/spark-2.3.2/spark-2.3.2-bin-hadoop2.7.tgz'
        }        
